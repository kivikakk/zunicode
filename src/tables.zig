...
pub const upper_lower = @as(i32, @intCast(max_rune)) + 1;

pub fn RangeTable(r16s: usize, r32s: usize) type {
    return struct {
        r16: [r16s]Range16,
        r32: [r32s]Range32,
        latin_offset: usize,
...
fn RangeTableFrom(comptime r16: []const Range16, comptime r32: []const Range32, latin_offset: usize) RangeTable(r16.len, r32.len) {
    return .{
        .r16 = r16[0..r16.len].*,
        .r32 = r32[0..r32.len].*,
...
const _White_Space = RangeTableFrom(
    &.{
        Range16.init(0x0009, 0x000d, 1),
        Range16.init(0x0020, 0x0020, 1),
        Range16.init(0x0085, 0x0085, 1),
